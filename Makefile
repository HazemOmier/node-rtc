...
test:
	...
	if [ $$CI == "true" ]; then export DISPLAY=:99.0; fi; $(NODE) ./test/node.cooptest.js 2> /tmp/nodertc.log & SERVER_PID=$$!; ./node_modules/.bin/karma start confs/karma.conf.js --single-run; kill $$SERVER_PID
