...
prepare_env:
	...
	cd third_party/trunk; ./build/gyp_chromium all.gyp -f make --depth=./ -Dinclude_tests=0 -Duse_system_protobuf=0; make libjingle_peerconnection libjingle libjingle_p2p libjingle_media webrtc protobuf_lite rbe_components opus libsrtp
