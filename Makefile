...
prepare_env:
	...
	cd third_party/trunk; GYP_DEFINES="include_tests=0 component=shared_library" ./depot_tools/gclient runhooks; make libjingle_peerconnection libjingle libjingle_p2p libjingle_media webrtc protobuf_lite rbe_components opus libsrtp

#./build/gyp_chromium all.gyp -f make --depth=./ -Dinclude_tests=0; make libjingle_peerconnection libjingle libjingle_p2p libjingle_media webrtc protobuf_lite rbe_components opus libsrtp
